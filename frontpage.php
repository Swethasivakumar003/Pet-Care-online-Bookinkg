...
<body>
	...
	<div class="header_section">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-4">
					<div><a href="index.php"><img src="Images/lighttwist-preview.png" style="width: 166px;"></a></div>
				</div>
				<div class="col-md-8">
					<div class="menu_text">
						<ul>
						<button style="border-radius: 38px;
    background: #f7941d;
    margin-left: 233px;
    margin-top: 39px;">	<a href="index.php">	<li class="last" style="color:white;margin-top: -20px;
    font-size: revert-layer;
    font-family: emoji;">Log in / Register</li></a></button>
			...
			<div class="container">
				<div class="ram">
					<div class="row">
					    ...
					    <div class="col-sm-12">
						    <h1 class="taital" style="width: 65%;
    float: left;
    font-size: 31pt;
    text-align: right;
    font-weight: 700;
    ...
    margin-top: 80px;
    font-family: emoji;
    color: #f7941d;">BEST PET CARE</h1>
						    <p class="consectetur_text" style="width: 90%;
    float: left;
    font-size: 24px;
    color: #fefcfc;
    line-height: 50px;
    margin-left: -155px 
">Adventure awaits, paws in the wind</p>
						    <!-- <div class="banner_bt">
	...
	<div class="about_section">
		<div class="about_text">
			<div class="container">
				...
				<p class="magna_text">"Dogs are the most amazing creatures; they give unconditional love. For me, they are the role model for being alive."</p>
				<!-- <div class="about_bt">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm-12">
				    ...
				    <p class="sed_text"> Dogs have been human's best friends for thousands of years. They are there for us through thick and thin. They never judge and are always happy to see us return, whether we've been gone five hours or five minutes.</p>
    	    ...
    	    <div class="footer_section_2">
		        <div class="row">
    		        <div class="col-sm-6 col-md-6 col-lg-3">
    		        	...
    		        	<p class="dummy_text">Our pet shop or pet service business is designed to fulfill the needs of pet owners and the animal that they own. Many Filipinos are used to having a pet at home, typically a dog or a cat.</p>
    		        </div>
    		        <div class="col-sm-6 col-md-6 col-lg-3">
